...
if(!document.querySelector('script[data-bq-reset-controls]')){const script=document.createElement('script');script.src='reset-controls.js?v=19';script.dataset.bqResetControls='1';document.body.appendChild(script)}
})();