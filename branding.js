(function () {
  ...
  function installBranding() {
    ...
    style.textContent = `
      .bq-splash{position:fixed;inset:0;z-index:2147483647;display:flex;align-items:center;justify-content:center;padding:32px;background:linear-gradient(160deg,#fffaf0 0%,#f8fbff 44%,#dbeaf6 100%);transition:opacity .42s ease,visibility .42s ease}
      ...
      .bq-splash-logo{width:min(210px,52vw);height:auto;filter:drop-shadow(0 18px 30px rgba(6,25,49,.16));animation:bqSplashIn .65s cubic-bezier(.2,.8,.2,1) both}
