...
assert.match(authUi, /redirectResult\?\.user \|\| firebase\.auth\.currentUser/);
assert.match(authUi, /if \(result\?\.user\) renderUser\(result\.user\)/);
...
console.log('✅ Cloud First, Home-Screen-Anmeldung, Eigentümereinladung und Brutto-Tragbarkeit sind eingebunden.');
