...
assert.match(authUi, /isFirebaseHosted/);
...
assert.match(worker, /budgetquest-v74/);
...
assert.match(firebaseConfig, /"hosting"/);
assert.match(firebaseConfig, /"site": "budgetquest-cloud"/);
assert.match(firebaseRc, /"default": "budgetquest-cloud"/);

console.log('✅ Cloud First, Firebase Hosting, iPhone-PWA-Anmeldung, Eigentümereinladung und Brutto-Tragbarkeit sind eingebunden.');
