...
assert.doesNotMatch(authUi, /signInWithRedirect/);
assert.doesNotMatch(authUi, /getRedirectResult/);
assert.match(authUi, /result\?\.user \|\| firebase\.auth\.currentUser/);
...
assert.match(worker, /budgetquest-v73/);
...
console.log('✅ Cloud First, direkte PWA-Google-Anmeldung, Eigentümereinladung und Brutto-Tragbarkeit sind eingebunden.');
